...
---
## Deliverables
- **When an error is thrown within any `render` function of a component:**
  ...
  - **bonus:** provide additional thoughts in this README's Discussion section below of how the dev team could best make use of the errors that are being reported to the backend!
